  ...
  context 'when initialized' do
    ...
    context 'with the words "the ultimate spoonerise test"' do
      ...
      context 'and no options' do
        ...
        it { expect(normal.to_h).to eq({'the'=>'e', 'ultimate'=>'spultimate', 'spoonerise'=>'toonerise', 'test'=>'thest'}) }
      ...
      context 'and reversed' do
        ...
        it { expect(reversed.to_h).to eq({'spoonerise' => 'oonerise', 'test' => 'spest', 'the' => 'te', 'ultimate' => 'thultimate'}) }
      end
      context 'and excluding "test"' do
        ...
        it { expect(excluding.to_h).to eq({'spoonerise' => 'thoonerise', 'test' => 'test', 'the' => 'e', 'ultimate' => 'spultimate' }) }
      end
      context 'and reversed, excluding "test"' do
        ...
        it { expect(rev_excl.to_h).to eq({'spoonerise' => 'oonerise', 'test' => 'test', 'the' => 'spe', 'ultimate' => 'thultimate' }) }
      end
      context 'and lazy' do
        ...
        it { expect(lazy.to_h).to eq({'spoonerise' => 'toonerise', 'test' => 'est', 'the' => 'the', 'ultimate' => 'spultimate' }) }
      end
      context 'and lazy, excluding "test"' do
        ...
        it { expect(lazy_excl.to_h).to eq({'spoonerise' => 'oonerise', 'test' => 'test', 'the' => 'the', 'ultimate' => 'spultimate'}) }
      end
      context 'and lazy, reversed' do
        ...
        it { expect(lazy_rev.to_h).to eq({'spoonerise' => 'oonerise', 'test' => 'spest', 'the' => 'the', 'ultimate' => 'tultimate' }) }
      end
      context 'and lazy, reversed, excluding "test"' do
        ...
        it { expect(lazy_excl_rev.to_h).to eq({'spoonerise' => 'oonerise', 'test' => 'test', 'the' => 'the', 'ultimate' => 'spultimate'}) }
      end
    end
  end
end
